    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <a href="/alumni/profile/data/edit/{{Auth::user()->id}}" class="btn btn-icon icon-left btn-success"><i class="fas fa-plus"></i> Update Data Profile</a>
            </div>
        </div>
    </div>
                          ...
                          <form class="form" action="##" method="post" id="registrationForm">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">      
                                    ...
                                    <input readonly value="{{Auth::user()->alamat_sekarang}}" type="textarea" class="form-control" name="alamat_sekarang" id="alamat_sekarang" placeholder="your addres" title="your addres.">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">      
                                    ...
                                    <input readonly value="{{Auth::user()->pekerjaan}}" type="text" class="form-control" name="pekerjaan" id="pekerjaan" placeholder="your jobs" title="your jobs.">
                                </div>
                            </div>
