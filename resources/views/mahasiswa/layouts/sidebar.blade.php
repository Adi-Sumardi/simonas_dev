        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="/mahasiswa/akademik">Akademik</a></li>
                        <li><a href="/mahasiswa/leadership">Leadership</a></li>
                        <li><a href="/mahasiswa/karakter">Karakter Islami</a></li>
                        <li><a href="/mahasiswa/kreatif">Kreatifitas & Kewirausahaan</a></li>
                    </ul>
                </li>

                <li>
                    <a href="/mahasiswa/history" class=" waves-effect">
                ...
                <li>
                    <a href="/mahasiswa/profile" class=" waves-effect">
