    ...
    <div class="row">
                    ...
                    <div class="modal fade bs-akademik-modal-xl" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                ...
                                <form action="/mahasiswa-profile-akademik-store" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal fade bs-leadership-modal-xl" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                ...
                                <form action="/mahasiswa-profile-leadership-store" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                    <div class="modal-body">
                                        <div class="container">
                                            <div class="row">
                    ...
                    <div class="modal fade bs-karakter-modal-xl" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                ...
                                <form action="/mahasiswa-profile-karakter-store" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                    <div class="modal-body">
                                        <div class="container">
                                            <div class="row">
                    ...
                    <div class="modal fade bs-kreatif-modal-xl" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                ...
                                <form action="/mahasiswa-profile-kreatif-store" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                    <div class="modal-body">
                                        <div class="container">
                                            <div class="row">
                    ...
                    <div class="modal fade bs-status-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="/mahasiswa-profile-status-update/{{Auth::user()->id}}" method="POST" enctype="multipart/form-data">
                                    @method('PATCH')
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                    <div class="modal-body">
                                        <div class="form-group">
                                ...
                                <form action="/mahasiswa-ipk-store" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="ip">IP: <span class="text-danger">*(Contoh Penulisan: 3.75) Jangan Pake "Koma ," !!!</span></label>
                                                    <input type="text" class="form-control @error('tahun') is-invalid @enderror"
                                                        name="ip">
                                                </div>
                                                @error('ip')
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-4">
                            <div class="text-right">
                                <div>
                                    <a href="/mahasiswa-profile-status-edit/{{Auth::user()->id}}" class="btn btn-outline-primary" data-toggle="modal" data-target=".bs-status-modal-center">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="float-right">
                        <a href="/mahasiswa-profile-info-edit/{{Auth::user()->id}}" class="btn btn-outline-primary" data-toggle="modal" data-target=".bs-info-modal-xl">
        ...
        <div class="col-md-12 col-xl-9">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="float-right">
                        <a href="/mahasiswa-profile-ips-create" class="btn btn-outline-success" data-toggle="modal" data-target=".bs-ips-modal-center">
                            ...
                            <table class="table table-centered mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->ip}}</td>
                                        <td>
                                            <a href="/mahasiswa-ipk-detail/{{$item->id}}" class="btn btn-outline-primary btn-sm">
                                                    <i class="mdi mdi-eye-circle-outline"></i> View</a>
                                            <a href="/mahasiswa-ipk-edit/{{$item->id}}" class="btn btn-outline-secondary btn-sm">
                                                    <i class="mdi mdi-file-edit-outline"></i> Edit</a>
                                            <a href="/mahasiswa-ipk-khs-edit/{{$item->id}}" class="btn btn-outline-info btn-sm">
