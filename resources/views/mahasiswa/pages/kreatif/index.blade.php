    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <a href="/mahasiswa/kreatif/create" class="btn btn-icon icon-left btn-success"><i class="fas fa-plus"></i> Tambah Data</a>
                <a href="/mahasiswa/kreatif/cetak_pdf" class="btn btn-icon icon-left btn-info"><i class="fas fa-download"></i> Download Data Kreatifitas PDF</a>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>                            
                                ...
                                <form action="/mahasiswa/kreatif/delete/{{$kreatif->id}}" method="POST">
                                    <a href="/mahasiswa/kreatif/edit/{{$kreatif->id}}" class="btn btn-icon btn-primary btn-action btn-sm" data-toggle="tooltip" title="" data-original-title="Edit" ><i class="fas fa-edit"></i></a>
                                    @csrf
                                    @method('DELETE')
