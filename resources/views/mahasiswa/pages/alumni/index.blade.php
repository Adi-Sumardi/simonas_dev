            ...
            <table class="table table-bordered table-striped table-hover" id="data-alumni">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>                       
                            <a href="/mahasiswa/alumni/detail/{{$user->id}}" class="btn btn-icon btn-secondary btn-action btn-sm" data-toggle="tooltip" title="" data-original-title="Detail" ><i class="fas fa-info"></i></a>
                        </td>
                    </tr>       
                    @endforeach
                </tbody>
