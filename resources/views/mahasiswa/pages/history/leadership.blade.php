        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <ul class="nav nav-pills">
                    <li class="nav-item">
                    <a class="nav-link" href="/mahasiswa/history/akademik">Akademik</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link active" href="/mahasiswa/history/leadership">Leadership</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="/mahasiswa/history/karakter">Karakter</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="/mahasiswa/history/kreatif">Kreatif</a>
                    </li>
                </ul>
            </div>
        </div>
