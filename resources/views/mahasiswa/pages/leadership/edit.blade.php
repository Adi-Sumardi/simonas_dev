...
<section class="section">
    ...
    <div class="card card-primary">
        ...
        <div class="card-body pt-1">
            <form method="POST" action="/mahasiswa/leadership/update/{{$leadership->id}}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="waktu" class="control-label">Waktu Kegiatan:</label><span
                                class="text-danger">
                            <input value="{{$leadership->waktu}}" type="date" class="form-control" name="waktu">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
