            ...
            <div class="card bg-gradient" style="background: linear-gradient(90deg, #c0fff3, #0095ff);">
                <div class="card-body">
                    <div class="button-items d-flex justify-content-center">
                        ...
                        <a href="/mahasiswa-warga-asgj" type="button" class="btn btn-primary waves-effect waves-light">ASG</a>
                        <a href="/mahasiswa-warga-asgj" type="button" class="btn btn-primary waves-effect waves-light">AWS</a>
