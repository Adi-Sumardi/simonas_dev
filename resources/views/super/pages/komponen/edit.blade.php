    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <form method="POST" action="/super-komponen-update/{{$komponens->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('kode') is-invalid @enderror"
                                            name="kode" value="{{$komponens->kode}}">
                                    </div>
                                    @error('kode')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('nama_komponen') is-invalid @enderror"
                                            name="nama_komponen" value="{{$komponens->nama_komponen}}">
                                    </div>
                                    @error('nama_komponen')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
