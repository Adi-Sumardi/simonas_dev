            ...
            <table class="table table-bordered table-striped table-hover" id="data-kreatif">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$kreatif->nilai}}</td>
                        <td>                            
                                <a href="/penilaian/kreatif/detail/{{$kreatif->id}}" class="btn btn-icon btn-secondary btn-action btn-sm" data-toggle="tooltip" title="" data-original-title="Detail" ><i class="fas fa-info-circle"></i></a>
                                <a href="/penilaian/kreatif/edit/{{$kreatif->id}}" class="btn btn-icon btn-success btn-action btn-sm" data-toggle="tooltip" title="" data-original-title="Nilai" ><i class="fas fa-file-signature"></i></a>
