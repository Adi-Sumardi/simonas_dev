                                    ...
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Asrama</td>
                                                <td> :</td>
                                                <td>{{ $kreatif->asrama }}</td>
                                            </tr>
                                            <tr>
                                                <td>Komponen</td>
                                                <td> :</td>
                                                <td> <strong> {{ $kreatif->komponen }}</strong></td>
                                            </tr>
                                            <tr>
                                                <td>Jenis Kegiatan</td>
                                                <td> :</td>
                                                <td> <strong> {{ $kreatif->kegiatan }}</strong></td>
                                            </tr>
                                            <tr>
                                                <td>Waktu</td>
                                                <td> :</td>
                                                <td> <strong> {{ $kreatif->waktu }}</strong></td>
                                            </tr>
                                            <tr>
                                                <td>Tempat Kegiatan</td>
                                                <td> :</td>
                                                <td> <strong> {{ $kreatif->tempat }}</strong></td>
                                            </tr>
                                            <tr>
                                                <td>Uraian Kegiatan</td>
                                                <td> :</td>
                                                <td> <strong> {{ $kreatif->keterangan }}</strong></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </address>
                          ...
                          <div class="col">
                            <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg">
                              <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                                ...
                                <br>
                                <address>
                                    <img src="{{ url('/data_file_kreatif/' . $kreatif->file) }}" class="img-thumbnail" style="height:auto; width:100%; vertical-align:middle; max-width:250px;" alt="">
                                </address>
                              </div>
                            </div>
                          </div>
