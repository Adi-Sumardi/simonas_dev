            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="button-items d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="{{ route('super-kegiatan-karakter-create')}}" type="button"
                        ...
                        <table class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                @foreach ($karakters as $index => $karakter)
                                    <tr>
                                        <td>{{ $index + $karakters->firstItem() }}</td>
                                        <td>{{ $karakter->nama_warga }}</td>
                                        <td>{{ $karakter->komponen }}</td>
                                        <td>{{ date('d-m-Y', strtotime($karakter->waktu)) }}</td>
                                        <td>{{ $karakter->tempat }}</td>
                                        <td>
                                            <a href="/super-kegiatan-karakter-detail/{{ $karakter->id }}"
