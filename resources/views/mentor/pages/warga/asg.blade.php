            ...
            <table class="table table-bordered table-striped table-hover" id="data-warga">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$user->asrama}}</td>
                        <td>                            
                            <a href="/mentor/warga-detail/{{$user->id}}" class="btn btn-icon btn-secondary btn-action btn-sm" data-toggle="tooltip" title="" data-original-title="Detail" ><i class="fas fa-info-circle"></i></a>
                        </td>
                    </tr>       
                    @endforeach
                </tbody>
