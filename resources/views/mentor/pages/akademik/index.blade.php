            ...
            <table class="table table-bordered table-striped table-hover" id="data-akademik">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>                            
                            <form action="/mentor/akademik/delete/{{$akademik->id}}" method="POST">
                                <a href="/mentor/akademik/detail/{{$akademik->id}}" class="btn btn-icon btn-secondary btn-action" data-toggle="tooltip" title="" data-original-title="Detail" ><i class="fas fa-info-circle"></i></a>
                                <a href="/mentor/akademik/edit/{{$akademik->id}}" class="btn btn-icon btn-primary btn-action btn-sm" data-toggle="tooltip" title="" data-original-title="Edit" ><i class="fas fa-edit"></i></a>
                                    @csrf
                                    @method('DELETE')
