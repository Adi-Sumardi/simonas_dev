            ...
            <table class="table table-bordered table-striped table-hover" id="data-leadership">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>                            
                            <form action="/mentor/leadership/delete/{{$leadership->id}}" method="POST">
                                <a href="/mentor/leadership/detail/{{$leadership->id}}" class="btn btn-icon btn-secondary btn-action" data-toggle="tooltip" title="" data-original-title="Detail" ><i class="fas fa-info-circle"></i></a>
                                    <a href="/mentor/leadership/edit/{{$leadership->id}}" class="btn btn-icon btn-primary btn-action btn-sm" data-toggle="tooltip" title="" data-original-title="Edit" ><i class="fas fa-edit"></i></a>
                                    @csrf
                                    @method('DELETE')
