...
<section class="section">
    ...
    <div class="card card-primary col-12 col-md-12 col-lg-12" style="overflow: scroll;">
        ...
        <div class="card-body pt-1">
            <form action="/admin/penilaian/kreatif/update/{{$kreatif->id}}" method="post">
                @csrf
                @method('PATCH')
                <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <a href="/admin/kreatif/file/download/{{$kreatif->file}}" class="btn btn-primary btn-sm"><i class="fa fa-download"></i> Download File</a>
                            </div>
                        </div>
                    </div>                  
                </div>
