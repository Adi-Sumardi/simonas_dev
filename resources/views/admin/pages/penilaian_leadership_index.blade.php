            ...
            <table class="table table-bordered table-striped table-hover" id="data-leadership">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>                            
                                <a href="/admin/penilaian/leadership/detail/{{$leadership->id}}" class="btn btn-icon btn-secondary btn-action btn-sm" data-toggle="tooltip" title="" data-original-title="Detail" ><i class="fas fa-info-circle"></i></a>
                                <a href="/admin/penilaian/leadership/edit/{{$leadership->id}}" class="btn btn-icon btn-success btn-action btn-sm" data-toggle="tooltip" title="" data-original-title="Nilai" ><i class="fas fa-file-signature"></i></a>
